            ...
            while ($testimonialPosts->have_posts()) {
                ...
                <article class="flex__container--reviews" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
                    <div class="img__title--container">
                        ...
                        <h6 class="blue-text review__title"><?php the_field('job_title'); ?></h6>
                        <h6 class="blue-text review__company"><?php the_field('company_name'); ?></h6>
                    </div>
                    <?php the_content(); ?>
                </article>
            <?php }
        ...
        <div class="flex__container--contact">
            <div class="contact__icon--container">
                <a class="social__icon--wrapper" href="mailto:johnson8727@hotmail.com" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" class="footer__icons" viewBox="0 0 16 16">
