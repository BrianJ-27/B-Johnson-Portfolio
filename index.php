...
<main class="main__grid--container">
    ...
    <section id="projects" class="flex__container">
        ...
        <div class="flex__container--cards text-center">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="<?php echo get_theme_file_uri('img/8th-project_800px.png'); ?>" alt="Employee Directory App">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="<?php echo get_theme_file_uri('img/7th-project_800px.png') ?>" alt="8th project of Treehouse Techdegree">
                <div class="card-block">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="<?php echo get_theme_file_uri('img/6th-project_800px.png'); ?>" alt="8th project of Treehouse Techdegree">
                <div class="card-block">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="<?php echo get_theme_file_uri('img/5th-project_800px.png'); ?>" alt="Photo Gallery Web Project">
                <div class="card-block">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="<?php echo get_theme_file_uri('img/Zoo-Institute-website_800px.png'); ?>" alt="8th project of Treehouse Techdegree">
                <div class="card-block">
        ...
        <div class="flex__container--references">
            ...
            <article class="flex__container--reviews">
                <div class="img__title--container">
                    <img class="img__person rounded-circle img-fluid" src="<?php echo get_theme_file_uri('img/randy.jpg'); ?>" alt="Picture of Randy Layne">
            ...
            <article class="flex__container--reviews">
                <div class="img__title--container">
                    <img class="img__person rounded-circle img-fluid" src="<?php echo get_theme_file_uri('img/alicia.jpg'); ?>" alt="Picture of Alicia Mendez">
            ...
            <article class="flex__container--reviews">
                <div class="img__title--container">
                    <img class="img__person rounded-circle img-fluid" src="<?php echo get_theme_file_uri('img/nestor.png'); ?>" alt="Picture of Nestor Padilla">
